...
const AdminOperation: React.FC = () => {
  ...
  //   axios
  //     .get(
  //       `${process.env.NEXT_PUBLIC_API_URL}/MES_TDAssignment/GetallShiftwiseData?ProcessId=1&UserId=E6045C33-56D6-441E-B80C-2EB803CEE031&Bar_Slno=12345678&FromDate=2024-05-29&ToDate=2024-05-29&ShiftIds=1,2`,
  //       {
  //         headers: {
  ...
  //     )
  //     .then((response) => {
  //       const Apiresponse = response.data // Store the actual response data here
  ...
  //filtering data using dates in the detailed view finished
    ...
    if (selectedOperator && selectedOperation && serialbarcode) {
      const fetchProgressData = async () => {
        try {
          ...
          console.log("Checking wcId", selectedWorkcenterId)
  ...
  //handling detailed view button
  const handleClick = (clickItem: string) => {
    setSelectedTitle(clickItem)
    setModal(true)
  }
  // const handleClick = () => {
  //   alert("hi showing detailed items")
  //   setModal(true)
  // }
  //handling detailed view button finished
    ...
    <div className="w-full md:flex gap-4 text-sm mb-6 mt-16">
      ...
      <div className="flex-col mt-8 gap-5 w-full md:w-52">
        ...
        <DropDown
          ...
          resetTrigger={null} // No reset for this dropdown
