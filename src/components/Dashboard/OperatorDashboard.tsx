...
import DashboardIconsComponent from "@/components/Dashboard/DashboardIconsComponent"

interface IOperatorDashboardProps {}

const OperatorDashboard: React.FunctionComponent<
  IOperatorDashboardProps
> = ({}) => {
  return (
    <>
      <div>
